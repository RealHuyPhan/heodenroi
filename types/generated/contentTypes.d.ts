...
export interface ApiAreaArea extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    barns: Schema.Attribute.Relation<'oneToMany', 'api::barn.barn'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiBarnBarn extends Struct.CollectionTypeSchema {
  collectionName: 'barns';
  info: {
    displayName: 'Barn';
    pluralName: 'barns';
    singularName: 'barn';
...
export interface ApiPigPig extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    healthStatus: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
